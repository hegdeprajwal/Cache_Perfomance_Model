...
L2Cache::L2Cache(int blk_size, int cache_size, int assoc, int next_enable) {
...
void L2Cache::cache_access(const char* access, unsigned long long address) {
...
void L2Cache::update_lru (int set, int way) {
...
void L2Cache::cache_miss_mgmt (int set, unsigned long long tag, int rw) {
